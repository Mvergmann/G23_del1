...
public class TestAfTerning {
    public static void main(String[] args) {
        ...
        int sum12 = 0;
        /*
         Her defineres en række variabler af typen int som bruges til at tælle antal gange tegningerne slår
        ...
        for (antGang = 0; antGang < antal; antGang++) {
            //for loopet slår terningen ti tusind gange for at bedømme om resultatet er statistisk tilfældigt
            die1.roll();
            die2.roll();
            ...
            //Disse if statements bruges til at tælle antallet af indstanser af forskellige resultater af terning slag
        }
        float a = sum2;
        float b = toens;
        //Laver sum2 og toens til nye variabler af typen float. (int kan ikke give decimal tal og ville derfor give 0 når vi regner procent %
        ...
        //Printer antallet af sum med forskellige værdier
        ...
        // regner og printer procent chancen for at terningen slår henholdsvis to 1'er og to ens.
